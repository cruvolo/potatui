...
- **Solar/space weather indicator** — live NOAA Kp geomagnetic index shown in the header. Flashes red and fires a warning toast when a geomagnetic storm alert is active. Click the pill to see Kp history, full alert text, and MUF/foF2 propagation prediction for your park's grid square (via prop.kc2g.com). Polls every 10 minutes; skipped in offline mode.
